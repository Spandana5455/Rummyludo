  ...
  <ol className="breadcrumb">
    ...
    <li className="breadcrumb-item active" aria-current="page">  13 Card Rummy</li>
      ...
      <h3>Printed Joker and Wild Card Jokers</h3>
        ...
        <p  className="para">The card-shuffling mechanism used by RummyLudo is approved by RNG (Random Number Generator) technology, ensuring impartial and equitable shuffling. The Australian company iTech Labs, which provided this RNG certification, utilizes an algorithm to guarantee that every card is chosen at random from a deck that has been carefully shuffled.</p>
        <h3>Open Card</h3>
